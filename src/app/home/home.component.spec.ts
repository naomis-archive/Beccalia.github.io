...
describe('HomeComponent', () => {
  ...
  it('should render the expected text', () => {
    ...
    expect(texts[1].innerText.trim()).toBe(
      'You can learn about their stories and play through their adventures by checking out the Games tab above. Or join our chat server and follow our Mastodon to stay in the loop on the latest updates!'
    );
  });
});
